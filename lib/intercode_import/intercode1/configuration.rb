...
module IntercodeImport
  module Intercode1
    class Configuration
        ...
        <<~PHP
          <?php
            ...
            $possible_position_names = array(
              "ADVERTISING","ATTENDEE_COORDINATOR","BID_CHAIR","CON_CHAIR","CON_SUITE",
              "GM_COORDINATOR","HOTEL_LIAISON","IRON_GM","OPS","OPS2","OUTREACH",
              "REGISTRAR","SAFETY_COORDINATOR","STAFF_COORDINATOR","THURSDAY","TREASURER","VENDOR_LIAISON"
            );
      ...
      def raw_vars
        @raw_vars ||= JSON.parse(Php.exec_php(php_dump_script, 'dump_con_vars.php'))
      end
